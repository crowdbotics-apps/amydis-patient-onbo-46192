"""
Django settings for amydis_patient_onbo_46192 project.
...
ROOT_URLCONF = 'amydis_patient_onbo_46192.urls'
...
WSGI_APPLICATION = 'amydis_patient_onbo_46192.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "amydis_patient_onbo_46192 API",
    "DESCRIPTION": "API documentation for amydis_patient_onbo_46192 App",
    "VERSION": "v1",
}
